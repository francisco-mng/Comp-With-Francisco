  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <nav className="text-sm text-slate-500 mb-8 font-medium">
        ...
        <span className="mx-2">/</span>
        <span className="text-slate-900">Refund & Cancellation</span>
      </nav>

      <SketchBox title="Refund and Cancellation Policy">
        ...
        <div className="space-y-8 text-slate-700">
          ...
          <section className="bg-amber-50 border-2 border-dashed border-amber-200 p-6 rounded-xl">
            <p className="text-base leading-relaxed">
              Welcome to <strong className="text-amber-900">Comp With Francisco</strong>. 
          ...
          <section className="space-y-3">
            ...
            <div className="border-l-4 border-amber-400 pl-4 space-y-2">
              <p className="font-semibold text-amber-700">Policy: Strictly Once-Off & Non-Refundable</p>
          ...
          <section className="space-y-3">
            ...
            <div className="border-l-4 border-blue-400 pl-4 space-y-2">
              <p className="font-semibold text-blue-700">Policy: Cancel Anytime, No Pro-Rated Refunds</p>
              <p className="leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <div className="border-l-4 border-slate-300 pl-4 space-y-2">
              <p className="font-semibold text-slate-600">Policy: Non-Refundable</p>
              <p className="leading-relaxed">
